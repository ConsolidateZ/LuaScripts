...
local T = {
        ["Menu"] = {
				{"          |cFF1b1f46AmdWoW Custom Enchants|r", 999},
				{"              |cFF4becff------------------------------|r                                                  |cFFaa7a3c.|r ", 999},
                {"Enchant: Headpiece", 0},
                {"Enchant: Shoulders", 2},
                {"Enchant: Chest", 4},
                {"Enchant: Legs", 6},
                ...
                {"Enchant: Gloves", 9},
                {"Enchant: Cloak", 14},
                {"Enchant: Main-Hand Weapons", 15},
                {"Enchant: Two-Handed Weapons", 151},
                {"Enchant: Off-Hand Weapons", 16},
                {"Enchant: Shields                                                                              |cFFaa7a3c.|r ", 161};
				{"              |cFF4becff------------------------------|r                                                  |cFFaa7a3c.|r ", 999},
				{"|cffCC00CC|TInterface\\Icons\\Spell_Shadow_SacrificialShield:20:20|t|r Close ", 999},
